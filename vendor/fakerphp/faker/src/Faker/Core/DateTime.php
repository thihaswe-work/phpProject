...
final class DateTime implements DateTimeExtension, GeneratorAwareExtension
{
    ...
    public function dateTimeAD(
        ...
        return $this->setTimezone(
            $this->getTimestampDateTime(
                $this->generator->numberBetween(
                    $min,
                    $this->getTimestamp($until)
                )
            ),
            $timezone
        );
    ...
    public function dateTimeBetween(
        ...
        if ($start > $end) {
            throw new \InvalidArgumentException(
                '"$from" must be anterior to "$until".'
            );
        }
    ...
    public function dateTimeThisWeek(
    ...
    public function dateTimeThisMonth(
        $until = 'last day of this month',
        string $timezone = null
    ): \DateTime {
    ...
    public function dateTimeThisYear(
        $until = 'last day of december',
        string $timezone = null
    ): \DateTime {
        return $this->dateTimeBetween(
    ...
    public function dateTimeThisDecade(
        $until = 'now',
        string $timezone = null
    ): \DateTime {
        ...
        return $this->dateTimeBetween(
            "first day of january $year",
            $until,
            $timezone
        );
    }

    public function dateTimeThisCentury(
        $until = 'now',
        string $timezone = null
    ): \DateTime {
