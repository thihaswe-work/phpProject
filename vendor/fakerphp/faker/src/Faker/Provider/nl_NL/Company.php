...
class Company extends \Faker\Provider\Company
{
    ...
    public function company()
    {
        ...
        switch ($determinator) {
            case 0:
                $companyName =
                    ...
                    ' ' .
                    static::randomElement(static::$type);
            ...
            case 1:
                $companyName =
                    static::randomElement(static::$product) .
                    strtolower(static::randomElement(static::$type));

                break;

            case 2:
                $companyName =
                    static::randomElement(static::$store) .
                    ' ' .
        ...
        if (Miscellaneous::boolean()) {
            return $companyName .
                ' ' .
                static::randomElement(static::$companySuffix);
        }
    ...
    public static function vat()
    {
        return sprintf(
            '%s%d%s%d',
            'NL',
            self::randomNumber(9, true),
            'B',
            self::randomNumber(2, true)
        );
    }
