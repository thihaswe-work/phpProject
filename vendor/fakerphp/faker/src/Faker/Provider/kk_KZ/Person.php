...
class Person extends \Faker\Provider\Person
{
     ...
     * @var array
     */
    public static $firstSequenceBitWeights = [
        1,
        2,
        3,
        4,
     ...
     * @var array
     */
    public static $secondSequenceBitWeights = [
        3,
        4,
        5,
        6,
    ...
    {
        $controlDigit = self::getControlDigit(
            $iinValue,
            self::$firstSequenceBitWeights
        );

        if ($controlDigit === 10) {
            return self::getControlDigit(
                $iinValue,
                self::$secondSequenceBitWeights
            );
        }
