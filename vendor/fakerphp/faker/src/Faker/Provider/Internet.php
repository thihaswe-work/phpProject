...
class Internet extends Base
{
    ...
    public function freeEmail()
    {
        return preg_replace(
            '/\s/u',
            '',
            $this->userName() . '@' . static::freeEmailDomain()
        );
    }
    ...
    public function password($minLength = 6, $maxLength = 20)
    {
        $pattern = str_repeat(
            '*',
            $this->numberBetween($minLength, $maxLength)
        );
    ...
    public function slug($nbWords = 6, $variableNbWords = true)
    {
        ...
        if ($variableNbWords) {
            $nbWords =
                (int) (($nbWords * self::numberBetween(60, 140)) / 100) + 1;
        }
    ...
    public function ipv4()
    {
        return long2ip(
            Miscellaneous::boolean()
                ? self::numberBetween(-2147483648, -2)
    ...
    public static function localIpv4()
    {
        ...
        return long2ip(
            static::numberBetween(ip2long($ipBlock[0]), ip2long($ipBlock[1]))
        );
    }
    ...
    protected static function transliterate($string)
    {
        ...
        if (
            class_exists(\Transliterator::class, false) &&
