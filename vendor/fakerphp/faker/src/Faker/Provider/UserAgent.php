...
class UserAgent extends Base
{
    ...
    public static function chrome()
    {
        ...
        $platforms = [
            ...
            ") AppleWebKit/$saf (KHTML, like Gecko) Chrome/" .
            self::numberBetween(36, 40) .
            '.0.' .
            self::numberBetween(800, 899) .
            ".0 Mobile Safari/$saf",
            '(' .
    ...
    public static function msedge()
    {
        ...
        $platforms = [
            '(' .
            static::windowsPlatformToken() .
            ") AppleWebKit/$saf (KHTML, like Gecko) Chrome/$chrv" .
            '.' .
            self::numberBetween(4000, 4844) .
            '.' .
            self::numberBetween(10, 99) .
            " Safari/$saf Edg/$chrv" .
            self::numberBetween(1000, 1146) .
            '.' .
            ...
            '.' .
            self::numberBetween(10, 99) .
            " Safari/$saf EdgA/$chrv" .
            self::numberBetween(1000, 1146) .
            '.' .
            self::numberBetween(0, 99),
            '(' .
            static::iosMobileToken() .
            ") AppleWebKit/$saf (KHTML, like Gecko) Version/15.0 EdgiOS/$chrv" .
            self::numberBetween(1000, 1146) .
            '.' .
            self::numberBetween(0, 99) .
            " Mobile/15E148 Safari/$saf",
        ];
    ...
    public static function firefox()
    {
        $ver =
            'Gecko/' .
            date('Ymd', self::numberBetween(strtotime('2010-1-1'), time())) .
            ' Firefox/' .
            self::numberBetween(35, 37) .
            '.0';
        ...
        $platforms = [
            ...
            static::windowsPlatformToken() .
            '; ' .
            static::randomElement(static::$lang) .
            '; rv:1.9.' .
            ...
            static::linuxPlatformToken() .
            '; rv:' .
            self::numberBetween(5, 7) .
            '.0) ' .
            $ver,
            '(' .
            static::macPlatformToken() .
            ' rv:' .
            self::numberBetween(2, 6) .
            '.0) ' .
            $ver,
        ];
    ...
    {
        $saf =
            self::numberBetween(531, 535) .
            '.' .
            self::numberBetween(1, 50) .
            '.' .
        ...
        if (Miscellaneous::boolean()) {
            ...
            $ver =
                self::numberBetween(4, 5) . '.0.' . self::numberBetween(1, 5);
        }
        ...
        $platforms = [
            ...
            ") AppleWebKit/$saf (KHTML, like Gecko) Version/$ver Safari/$saf",
            '(' .
            static::randomElement($mobileDevices) .
            ' ' .
            self::numberBetween(7, 8) .
            '_' .
            self::numberBetween(0, 2) .
            '_' .
            self::numberBetween(1, 2) .
            ' like Mac OS X; ' .
            static::randomElement(static::$lang) .
            ") AppleWebKit/$saf (KHTML, like Gecko) Version/" .
            self::numberBetween(3, 4) .
            '.0.5 Mobile/8B' .
            self::numberBetween(111, 119) .
            " Safari/6$saf",
        ];
    ...
    public static function opera()
    {
        $platforms = [
            ...
            static::randomElement(static::$lang) .
            ') Presto/2.' .
            self::numberBetween(8, 12) .
            '.' .
            self::numberBetween(160, 355) .
            ' Version/' .
            self::numberBetween(10, 12) .
            '.00',
            '(' .
            static::windowsPlatformToken() .
            '; ' .
    ...
    public static function internetExplorer()
    {
        return 'Mozilla/5.0 (compatible; MSIE ' .
            self::numberBetween(5, 11) .
            '.0; ' .
            static::windowsPlatformToken() .
            '; Trident/' .
            self::numberBetween(3, 5) .
            '.' .
            self::numberBetween(0, 1) .
            ')';
    }
    ...
    {
        return 'Macintosh; ' .
            static::randomElement(static::$macProcessor) .
            ' Mac OS X 10_' .
            self::numberBetween(5, 8) .
            '_' .
