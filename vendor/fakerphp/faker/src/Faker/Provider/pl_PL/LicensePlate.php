...
class LicensePlate extends Base
{
    ...
    public static function licensePlate(
        ...
        $voivodeshipsAvailable =
            static::$voivodeships + ($special ? static::$specials : []);
        $voivodeshipCode = static::selectRandomArea(
            $voivodeshipsAvailable,
            $voivodeships
        );
        ...
        $suffix = static::regexify(
            static::randomElement(
                strlen($countyCode) === 1
                    ? static::$plateSuffixesGroup1
                    : static::$plateSuffixesGroup2
            )
        );
     ...
     */
    protected static function selectRandomArea(
        array $available,
        ?array $requested
    ) {
