...
class Payment extends Base
{
    ...
    public static function iban(
        ...
        $countryCode =
            null === $countryCode
                ? self::randomKey(self::$ibanFormats)
