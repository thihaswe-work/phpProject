...
class PhoneNumber extends \Faker\Provider\PhoneNumber
{
    ...
    public function phoneNumber()
    {
        ...
        return static::numerify(
            static::randomElement(static::$normalFormats[$type])
        );
    }
    ...
    {
        return static::numerify(
            static::randomElement(static::$specialFormats['toll-free'])
        );
    }
    ...
    {
        return static::numerify(
            static::randomElement(static::$specialFormats['premium-rate'])
        );
    }
}
