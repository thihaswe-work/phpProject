...
class Address extends \Faker\Provider\Address
{
    ...
    public static function buildingNumber()
    {
        return static::toUpper(
            static::lexify(
                static::numerify(static::randomElement(static::$buildingNumber))
            )
        );
    }
    ...
    {
        $format = static::toUpper(
            static::lexify(
                static::numerify(
                    static::randomElement(static::$streetNameFormats)
                )
            )
        );
    ...
    public function township()
    {
        $format = static::toUpper(
            static::lexify(
                static::numerify(
                    static::randomElement(static::$townshipFormats)
                )
            )
        );
    ...
    public static function postcode($state = null)
    {
        ...
        $postcode =
            null === $state ? static::randomElement($format) : $format[$state];
