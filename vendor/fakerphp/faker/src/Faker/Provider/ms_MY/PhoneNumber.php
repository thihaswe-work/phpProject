...
class PhoneNumber extends \Faker\Provider\PhoneNumber
{
    ...
    protected static $zeroOneFourPrefix = [
        '2',
        '3',
        '4',
        '5',
    ...
    public function mobileNumber($countryCodePrefix = true, $formatting = true)
    {
        ...
        if ($countryCodePrefix) {
            return static::countryCodePrefix($formatting) .
                static::numerify($this->generator->parse($format));
        }
    ...
    public static function zeroOneOnePrefix()
    {
        return static::numerify(
            static::randomElement(static::$zeroOneOnePrefix)
        );
    }
    ...
    {
        return static::numerify(
            static::randomElement(static::$zeroOneFourPrefix)
        );
    }
    ...
    {
        return static::numerify(
            static::randomElement(static::$zeroOneFivePrefix)
        );
    }
    ...
    {
        if ($formatting) {
            return static::randomElement(static::$plusSymbol) .
                static::randomElement(static::$countryCodePrefix);
        }
